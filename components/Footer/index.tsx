            ...
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                <a href="/" className="relative">
                        <div className="text-blue-500   py-2 rounded-lg font-bold text-3xl">
              ilmi<span className="text-green-500">box</span>
            </div>
                </a>

                <p className="mb-10 mt-5">
                  Yamani Islamic Learning Laptop for Kids <br/>
Fun Islamic Learning Toy Laptop for Kids (50+ Activities)
                </p>
